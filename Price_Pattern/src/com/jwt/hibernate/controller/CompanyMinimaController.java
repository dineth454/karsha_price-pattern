...
@Path("/CompanyMinimaController")
public class CompanyMinimaController {
	@Path("{minimaGraphData}")
	@GET
	@Produces("application/json")
	public Response genMinimaJson(@PathParam("minimaGraphData") int permno){
		CompanyEventDAO companyEvent = new CompanyEventDAO();
		List<List<companydetails>> list =  companyEvent.retMinima(permno);
