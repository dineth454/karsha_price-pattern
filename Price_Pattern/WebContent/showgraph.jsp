...
<link href="css/themes/green/pace-theme-center-simple.css"
	rel="stylesheet" />
...
<body>
			...
			<div class="col-md-5">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-4" id="dperm">
							<h5>
								<b>TSYMBOL</b>
							</h5>
							<script>
								document.write(tsymbol)
							</script>
						</div>
						<div class="col-md-4" id="dtsym">
							<h5>
								<b>PERMNO</b>
							</h5>
							<script>
								document.write(permno)
							</script>
						</div>
						<div class="col-md-4" id="dnaics">
							<h5>
								<b>NAICS</b>
							</h5>
							<script>
								document.write(Naics)
							</script>
						</div>
					</div>
	...
	<script>
		setTimeout(function() {
			chart = c3.generate({
				data : {
					url : '/Price_Pattern/getDetails/CompanyPriceController/'
							+ permno,
					mimeType : 'json',
					keys : {
